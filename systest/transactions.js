 ...
 * IBM client - Blockchain Solution Framework
...
describe.only('Transaction system tests', () => {
    ...
    it.only('should submit and execute a transaction that contains primitive types', () => {
