...
module.exports.builder = {
    businessNetworkId: {alias: 'n', required: true, describe: 'The business network identifier', type: 'string' },
    connectionProfileName: {alias: 'p', optional: true, describe: 'The connection profile name', type: 'string' },
    registryPattern: {alias: 'r', optional: true, describe: 'The registries to list', type: 'string' },
