...
const businessNetwork = concertoAdmin.BusinessNetwork;
...
module.exports.handler = (argv) => {
    ...
    return (() => {
        ...
        console.log('Parms: Id='+argv.enrollId+' secret='+argv.enrollSecret+' archive='+argv.archiveFile+' networkName ='+argv.networkName);
   ...
   .then (() => {
       ...
       return businessNetwork.fromArchive(fileContents);
   })
   .then ((result) => {
       businessNetworkDefinition = result;
       console.log('Connect to Business network registry');
