...
class AdminConnection {
    ...
    /**
     * Register a new user, and return an enrollment secret that should be used
     * to login to a business network.
     ...
     */
    registerUser(enrollmentID) {
        Util.securityCheck(this.securityContext);
        return this.connection.registerUser(this.securityContext, enrollmentID);
    }
