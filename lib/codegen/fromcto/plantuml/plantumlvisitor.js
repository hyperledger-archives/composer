...
class PlantUMLVisitor {
    ...
    visitBusinessNetwork(businessNetwork, parameters) {
        ...
        parameters.fileWriter.writeLine(0, businessNetwork.getDescription() );
        ...
        const txProcessor = businessNetwork.getIdentifier();
        parameters.fileWriter.writeLine(0, 'class ' + txProcessor + ' << (N,brown) >> {' );
        businessNetwork.getScriptManager().accept(this,parameters);
