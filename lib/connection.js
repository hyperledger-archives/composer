...
class Connection {
    ...
    /**
     * Returns the name of the business network associated with this connection or null.
     * @return {string} the name of the business network associated with this connection
     */
    getBusinessNetworkName() {
        if(!this.businessNetworkIdentifier) {
            ...
            const dashIndex = this.businessNetworkIdentifier.lastIndexOf('-');
            if (dashIndex >= 0) {
                return this.businessNetworkIdentifier.substring(0, dashIndex);
            } else {
