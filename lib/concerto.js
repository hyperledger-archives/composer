...
/**
 * Use this class to connect to and then interact with a deployed BusinessNetwork.
...
class Concerto extends EventEmitter {
    ...
    constructor(options) {
        ...
        if (!this.connectionManager) {
            ...
            this.connectionManager = new(req(mod))(this.connectionProfileManager);
        }

        this.connectionProfileManager.addConnectionManager('hfc', this.connectionManager);
        this.connection = null;
    ...
    /**
     * Returns the currently connected BusinessNetwork
     * @returns {BusinessNetwork} the business network
     */
    getBusinessNetwork() {
    ...
    getAllAssetRegistries() {
        ...
        return AssetRegistry.getAllAssetRegistries(this.securityContext, this.modelManager, this.factory, this.serializer);
    }
    ...
    getAssetRegistry(id) {
        Util.securityCheck(this.securityContext);
        return AssetRegistry.getAssetRegistry(this.securityContext, id, this.modelManager, this.factory, this.serializer);
    }
    ...
    addAssetRegistry(id, name) {
        Util.securityCheck(this.securityContext);
        return AssetRegistry.addAssetRegistry(this.securityContext, id, name, this.modelManager, this.factory, this.serializer);
    }
    ...
    getTransactionRegistry() {
        ...
        return TransactionRegistry
            .getAllTransactionRegistries(this.securityContext, this.modelManager, this.factory, this.serializer)
     ...
     * @return {Promise} A promise to a BusinessNetwork that indicates the connection is complete
     */
