...
class BusinesNetworkConnection extends EventEmitter {
    ...
    /**
     * Create an instance of the BusinesNetworkConnection class. The connect method
     ...
     * @returns {BusinessNetworkDefinition} the business network or null if not connected
     */
    getBusinessNetwork() {
