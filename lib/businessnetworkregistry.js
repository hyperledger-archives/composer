...
class BusinessNetworkRegistry {
    ...
    addBusinessNetwork(businessNetwork) {
      ...
      // 1. deploy concerto (forcing a new chaincode id)
      // -- passing in Base64 encoded version of the BusinessNetwork archive
      // 2. Store the business network locally in some sort of index...
      //
    }
