...
class ConnectionProfileManager {
   ...
   */
    ...
    getConnectionManager(connectionProfile) {
        ...
        .then((data) => {
            const connectionManager  = this.connectionManagers[data.type];
            if(!connectionManager) {
                throw new Error('Failed to find a connection profile, or registered connection manager for ' + connectionProfile );
            }
