...
class WebConnection extends Connection {
    ...
    login(enrollmentID, enrollmentSecret) {
        ...
        if (this.businessNetworkIdentifier) {
            let chaincodeUUID = WebConnection.getBusinessNetwork(this.businessNetworkIdentifier, this.connectionProfile);
            if (chaincodeUUID) {
    ...
    deploy(securityContext, force, businessNetwork) {
        ...
        WebConnection.addBusinessNetwork(businessNetwork.getName(), this.connectionProfile, chaincodeUUID);
        WebConnection.addChaincode(chaincodeUUID, container, engine);
    ...
    queryChainCode(securityContext, functionName, args) {
        ...
        let chaincode = WebConnection.getChaincode(chaincodeUUID);
