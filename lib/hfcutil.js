...
const LOG = require('@ibm/ibm-concerto-common').Logger.getLog('HFCUtil');
...
class HFCUtil {
     ...
     */
    static registerUser(securityContext, enrollmentID) {
