...
const yargs = require('yargs')
    ...
    .option('n', { alias: 'businessNetwork', describe: 'The business network identifier', type: 'string', default: process.env.COMPOSER_BUSINESS_NETWORK })
    .option('p', { alias: 'connectionProfile', describe: 'The connection profile name', type: 'string', default: process.env.COMPOSER_CONNECTION_PROFILE })
