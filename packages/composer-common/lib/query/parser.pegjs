 ...
 * ===================
 *
 * The capabilities of the query language are based on the features of the
 * CouchDB backing store: http://docs.couchdb.org/en/2.0.0/api/database/find.html#selector-basics
 *
 */
{
...
OrderByToken     = "ORDER BY"  !IdentifierPart
SkipToken        = "SKIP"      !IdentifierPart
LimitToken       = "LIMIT"     !IdentifierPart
AscToken         = "ASC"       !IdentifierPart
DescToken        = "DESC"      !IdentifierPart
...
// Not yet implemented, but supported by CouchDB
// NotToken        = "NOT"        !IdentifierPart
// InToken         = "IN"         !IdentifierPart
// LikeToken       = "LIKE"       !IdentifierPart
// NotInToken      = "NOT IN"     !IdentifierPart
...
SortDirection
 = AscToken { return "ASC"; }
 / DescToken { return "DESC"; }

OrderBy
  = OrderByToken sort:Sort {
    return {
      sort: sort,
    };
  }
...
SortArray
  = __ "[" _ first:SortSingleField _ rest:SortRest* "]" {
    return [first].concat(rest);
  }

SortRest
  = "," item: SortSingleField {
    return item;
  }

SortSingleField
  = __ fieldName:Identifier __ direction:SortDirection? {
    return {
      fieldName: fieldName,
      direction: direction
    };
