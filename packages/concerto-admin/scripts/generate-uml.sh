...
node ./node_modules/@ibm/concerto-common/lib/codegen/parsejs.js --format PlantUML --inputDir "$DIR/lib" --outputDir "$DIR/out/uml"
node ./node_modules/@ibm/concerto-common/lib/codegen/parsejs.js --format PlantUML --private --inputDir "$DIR/lib" --outputDir "$DIR/out/uml-private"
