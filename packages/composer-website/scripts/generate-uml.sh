...
node "$TRAVIS_BUILD_DIR/node_modules/composer-common/lib/codegen/parsejs.js" --format PlantUML --inputDir "$TRAVIS_BUILD_DIR/node_modules/composer-common/lib" --outputDir "$DIR/out/uml"
...
node "$TRAVIS_BUILD_DIR/node_modules/composer-common/lib/codegen/parsejs.js" --format PlantUML --inputDir "$TRAVIS_BUILD_DIR/node_modules/composer-client/lib" --outputDir "$DIR/out/uml"
...
node "$TRAVIS_BUILD_DIR/node_modules/composer-common/lib/codegen/parsejs.js" --format PlantUML --inputDir "$TRAVIS_BUILD_DIR/node_modules/composer-admin/lib" --outputDir "$DIR/out/uml"
...
node "$TRAVIS_BUILD_DIR/node_modules/composer-common/lib/tools/plantumltoimage.js" --inputDir "$DIR/out/uml" --outputDir "$DIR/jekylldocs/jsdoc/diagrams"
