...
describe('EditorComponent', () => {
    ...
    describe('deploy', () => {
        ...
        xit('should handle error from upgrade modal', fakeAsync(inject([SampleBusinessNetworkService], (sampleBusinessNetworkService: SampleBusinessNetworkService) => {
            component['canDeploy'] = true;
            mockModal.open = sinon.stub().returns({
                componentInstance: {},
                result: sinon.stub().rejects('some error')
            });
        ...
        xit('should handle cancel from upgrade modal', fakeAsync(inject([SampleBusinessNetworkService], (sampleBusinessNetworkService: SampleBusinessNetworkService) => {
            component['canDeploy'] = true;
            mockModal.open = sinon.stub().returns({
                componentInstance: {},
        ...
        xit('should handle ESC from upgrade modal', fakeAsync(inject([SampleBusinessNetworkService], (sampleBusinessNetworkService: SampleBusinessNetworkService) => {
            component['canDeploy'] = true;
            mockModal.open = sinon.stub().returns({
                componentInstance: {},
