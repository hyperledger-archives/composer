...
describe('ConnectionProfileDataComponent', () => {
  ...
  describe('expandSection', () => {
    ...
    it('should error on unknown profile type', () => {
      ...
      (function(){component.expandSection(sectionToExpand)}).should.throw('Invalid connection profile type')
    });
  ...
  describe('useProfile', () => {
    it('should use a new profile', () => {
      ...
      mockConnectionProfileService.setCurrentConnectionProfile.should.have.been.calledWith('testprofile')
    });
  })
  ...
  describe('startEditing', () => {
    ...
    it('should error if unknown form type', () => {
      ...
      (function(){component.startEditing()}).should.throw('Unknown connection profile type');
  ...
  describe('addOrderer', () => {
    it('should add an orderer', () => {
      ...
      component['v1Form'] = component['fb'].group(
        {'orderers' : component['fb'].array([component['fb'].group({'url':'ordererURL_2','cert':'ordererCert_2','hostnameOverride':'ordererHostname_2'})])
      })
  ...
  describe('initPeers', () => {
    it('should initialize peers if theres connection profile data', () => {
      ...
      'profile':
        {'peers':[
          {'requestURL':'requestURL_1','eventURL':'eventURL_1','cert':'peerCert_1','hostnameOverride':'peerHostname_1'},
          {'requestURL':'requestURL_2','eventURL':'eventURL_2','cert':'peerCert_2','hostnameOverride':'peerHostname_2'}]
        }
      };
  ...
  describe('addPeer', () => {
    it('should add a peer', () => {
      ...
      component['v1Form'] = component['fb'].group(
        {'peers' : component['fb'].array([component['fb'].group({'requestURL':'requestURL_1','eventURL':'eventURL_1','cert':'peerCert_1','hostnameOverride':'peerHostname_1'})])
      })
  ...
  describe('onValueChanged', () => {
    ...
    it('should error if profile type is invalid',() => {
      component['connectionProfileData'] = {'profile':{'type':'invalidType'}};
      (function(){component.onValueChanged()}).should.throw('Invalid connection profile type')
    })
  ...
  describe('onSubmit',() => {
    ...
    it('should throw error on unknown profile type',fakeAsync(() => {
      ...
      (function(){component.onSubmit()}).should.throw('Unknown profile type');
      tick();
  ...
  describe('openAddCertificateModal',() => {
    it('should open orderers certificate modal if hostname set',() => {
      component['v1Form'] = component['fb'].group({
        'orderers' : component['fb'].array([component['fb'].group({'url':'ordererURL_2','cert':'ordererCert_2','hostnameOverride':''})])
      })
      mockNgbModal.open.returns({'result':Promise.resolve({'url':'ordererURL_2','cert':'ordererCert_2','hostnameOverride':'hostname_2'})});
    ...
    it('should open orderers certificate modal if hostname not set',() => {
      ...
      mockNgbModal.open.returns({'result':Promise.resolve({'url':'ordererURL_2','cert':'ordererCert_2','hostnameOverride':''})});
    ...
    it('should open peers certificate modal if hostname set',() => {
      ...
      mockNgbModal.open.returns({'result':Promise.resolve({'requestURL':'requestURL_1','eventURL':'eventURL_1','cert':'peerCert_1','hostnameOverride':'hostname_1'})});
    ...
    it('should open peers certificate modal if hostname not set',() => {
      ...
      mockNgbModal.open.returns({'result':Promise.resolve({'requestURL':'requestURL_1','eventURL':'eventURL_1','cert':'peerCert_1','hostnameOverride':''})});
