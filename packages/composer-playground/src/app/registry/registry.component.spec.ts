...
import { BusinessNetworkDefinition, Util, Serializer, Resource } from 'composer-common';
...
describe(`RegistryComponent`, () => {
  ...
  let mockCheckOverFlowDirective;
  ...
  describe('#openDeleteResourceModal', () => {
    ...
    it('should run loadResources', fakeAsync(() => {
      ...
      tick();
      component.loadResources.should.be.called;
      mockNgbModalRef.componentInstance.confirmMessage.should.
      equal('Please confirm that you want to delete Asset: ' + mockResource.getIdentifier());
    }));
